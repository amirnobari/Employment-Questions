...
<p align="center">⚠️برای ارتباط با تیم DeepDevs روی لینک تلگرام بزنید ⚠️</p>
...
اینundefined یک مقدار پیشفرض برای متغیرهایی هست که مقدار ندارن. یعنی موقع ساختن این متغیر بهش مقدار داده نشده
وundefined یک خروجی پیشفرض هست برای تابعی که return نداره
...
‌وAND منطقی مقدار اولین عبارت falsy رو برمی‌گردونه و اگه عبارتی falsy نبود، مقدار آخرین عبارت رو برمی‌گردونه.
...
چرا به توابع جاوا اسکریپت می‌گن موجودیت درجه یک؟
...
مفهوم ECMAScript چیه؟

<details><summary><b>پاسخ</b></summary>
<p>

 مفهوم ECMAScript یا اکما اسکریپت یک استاندارد هست. و زبان‌هایی مثل جاوااسکریپت و اکشن‌اسکریپت طبق این استاندارد طراحی شدن. پس جاوااسکریپت و اکشن‌اسکریپت از اکما اسکریپت به عنوان هسته خودشون استفاده می‌کنن و زیر مجموعه‌ای از اکما اسکریپت هستن. مثل سه اتومبیل با ظاهر و مشخصات متفاوت اما موتور یکسان!
